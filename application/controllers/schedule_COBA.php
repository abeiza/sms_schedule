			...
			//kode baru dengan kode ba
				...
				if(count($product) === count($qty) and count($fail) === 0){
					...
					if ($count_stts['1'] == count($product) and $query_outlet->num_rows() > 0 and $query_ba->num_rows() > 0){
						$data_a1['ID_BA'] = $ba;
						$data_a1['Processed'] = 'valid';
						$data_a1['ReplySMS'] = 'Terimakasih, sms anda akan segera kami proses [Format Baru]';
						$query_update = $this->model_app->getUpdateMy('Final_Inbox',$data_a1,'ObjectID',$db->ObjectID);
						
						$data_a2['ReplySMS'] = 'Terimakasih, sms anda akan segera kami proses [Format Baru]';
						$query_update2 = $this->model_app->getUpdateMy('new_inbox',$data_a2,'object_id',$db->RefObjectID);
						//echo "SUKSES SIMPAN VALID";
						//$dataout3['DestinationNumber'] = $sender;
						...
						$data_b1['ID_BA'] = "";
						$data_b1['Processed'] = 'invalid';
						$data_b1['ReplySMS'] = 'Maaf, Kode BA tidak terdaftar. Mohon anda periksa kembali kode BA[Format Baru]';
						$query_update = $this->model_app->getUpdateMy('Final_Inbox',$data_b1,'ObjectID',$db->ObjectID);
						
						$data_b2['ReplySMS'] = 'Maaf, Kode BA tidak terdaftar. Mohon anda periksa kembali kode BA[Format Baru]';
						$query_update2 = $this->model_app->getUpdateMy('new_inbox',$data_b2,'object_id',$db->RefObjectID);
						//echo "gagal";
						//$dataout2['DestinationNumber'] = $sender;
						...
						//}
						$data_c1['ID_BA'] = $ba;
						$data_c1['Processed'] = 'invalid';
						$data_c1['ReplySMS'] = 'Maaf, Kode Toko tidak terdaftar. Mohon anda periksa kembali kode toko [Format Baru]';
						$query_update = $this->model_app->getUpdateMy('Final_Inbox',$data_c1,'ObjectID',$db->ObjectID);
						
						$data_c2['ReplySMS'] = 'Maaf, Kode Toko tidak terdaftar. Mohon anda periksa kembali kode toko [Format Baru]';
						$query_update2 = $this->model_app->getUpdateMy('new_inbox',$data_c2,'object_id',$db->RefObjectID);
						//echo "gagal";
						//$dataout2['DestinationNumber'] = $sender;
						...
						//}
						$data_d1['ID_BA'] = $ba;
						$data_d1['Processed'] = 'invalid';
						$data_d1['ReplySMS'] = 'Maaf, Ada Kode Barang yang tidak terdaftar. Kode Barang '.$prd.' Tidak Terdaftar. Mohon anda periksa kembali Kode Barang [Format Baru]';
						$query_update = $this->model_app->getUpdateMy('Final_Inbox',$data_d1,'ObjectID',$db->ObjectID);
						
						$data_d2['ReplySMS'] = 'Maaf, Ada Kode Barang yang tidak terdaftar. Kode Barang '.$prd.' Tidak Terdaftar. Mohon anda periksa kembali Kode Barang [Format Baru]';
						$query_update2 = $this->model_app->getUpdateMy('new_inbox',$data_d2,'object_id',$db->RefObjectID);
						//echo "gagal";
						//$dataout2['DestinationNumber'] = $sender;
				...
				/*foreach($query_ba1->result() as $bad){
						$data_d['ID_BA'] = $bad->ID_BA;
				}*/
				$data_d['ID_BA'] = "";
				$data_d['Processed'] = 'invalid';
				$data_d['ReplySMS'] = 'Format tidak sesuai format baru atau format lama.';
				$query_update = $this->model_app->getUpdateMy('Final_Inbox',$data_d,'ObjectID',$db->ObjectID);
